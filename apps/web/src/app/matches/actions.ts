...
export async function createScheduledMatch(formData: FormData): Promise<ActionResult> {
  ...
  if (homeSelect === awaySelect) {
    return { success: null, error: 'Home and away team cannot be the same.', ok: false };
  }
