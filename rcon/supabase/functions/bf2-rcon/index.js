...
var server_ts_1 = require("https://deno.land/std@0.131.0/http/server.ts");
var client_1 = require("../../../src/client");
var _a = Deno.env.toObject(), host = _a.host, port = _a.port, password = _a.password;
console.log('Hello from Functions!');
(0, server_ts_1.serve)(function (req) { return __awaiter(void 0, void 0, void 0, function () {
    var url, client, cmd, data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3: return [2 /*return*/, new Response('No command defined', { headers: { 'Content-Type': 'application/json' } })];
        }
    });
}); });
// To invoke:
